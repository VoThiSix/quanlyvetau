<?php
            if($_SERVER["REQUEST_METHOD"]=="POST")
            {
                ...
                if (empty($error))
                {                      
                    $query = "insert into lichtrinh(malichtrinh, gadi_id, gaden_id ,ngaydi,ngayve,chieudi,khoihanh,matau ) values('$malichtrinh','$gadi_id', '$gaden_id', '$ngaydi','$ngayve', '$khoihanh','$matau', '$chieudi')";
                    $count=$db->exec($query);
                }
            }
        ?>
